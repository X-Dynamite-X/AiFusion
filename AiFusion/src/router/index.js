...
const routes = [
  ...
  { path: "/:provider/callback", component: ProviderCallbackView, name: "ProviderCallback" },
...
router.beforeEach(async (to, from, next) => {
  ...
  const publicPages = ['login', 'register', 'ForgotPassword', 'ResetPassword',"ProviderCallback"];
